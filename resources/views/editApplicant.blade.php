        ...
        <div class="personal-detail">
            ...
            <div class="formpart">
                <div class="inputfield">
                    <label>Name : </label>
                    <input class="field" type="text" name="name" value="{{$students->name}}" placeholder="enter name">
                </div>
                <div class="inputfield">
                    <label>Email : </label>
                    <input class="field" type="text" name="email" value="{{$students->email}}" placeholder="enter email">
                </div>
                <div class="inputfield">
                    <label>Address : </label>
                    <input class="field" type="text" name="address" value="{{$students->address}}" placeholder="enter address">
                </div>
                <div class="inputfield">
                    <label>Phone : </label>
                    <input class="field" type="text" name="contact" value="{{$students->contact}}" placeholder="enter contact">
                </div>
                <div class="inputfield">
                    <label>DOB : </label>
                    <input class="field" type="date" name="dob" value="{{$students->dob}}" placeholder="enter dob">
                </div>
                <div class="inputfield">
                ...
                <div class="inputfield">
                    ...
                    <input class="field" type="text" name="gurdain_name" value="{{$students->gurdain_name}}" placeholder="enter gurdain name">
                </div>
                <div class="inputfield">
                    <label>Gurdain no : </label>
                    <input class="field" type="text" name="gurdain_no" value="{{$students->gurdain_no}}" placeholder="enter gurdain contact">
                </div>
            </div>
        </div>
            ...
            <div class="formpart">
                <div class="inputacademicfield">
                    <div class="headertext">
                     ...
                     <div class="inputfield">
                        <label>Level : </label>
                        <input class="field" type="text" name="slclevel"  value="{{$students->slc}}" placeholder=" eg : slc ">
                       </div>
                   <div class="inputfield">
                    <label>CGPA/GRADE : </label>
                    <input class="field" type="text" name="slcgrade"  value="{{$students->slc_score}}" placeholder="eg : A+">
                   </div>
                   <div class="inputfield">
                    <label>PassOutYear : </label>
                    <input class="field" type="date" name="slcpassoutyear" value="{{$students->slc_passoutyear}}"  placeholder="eg : 2017">
                   </div>
                </div>
                </div>
                <div class="inputacademicfield">
                    <div class="headertext">
                     ...
                     <div class="inputfield">
                        <label>level : </label>
                        <input class="field" type="text" name="plus2level"  value="{{$students->plus2}}" placeholder="eg : +2">
                       </div>
                   <div class="inputfield">
                    <label>CGPA/GRADE : </label>
                    <input class="field" type="text" name="plus2grade"  value="{{$students->plus2_score}}" placeholder="eg : 3.4 / 59%">
                   </div>
                   <div class="inputfield">
                    <label>PassOutYear : </label>
                    <input class="field" type="date" name="plus2passoutyear"  value="{{$students->plus2_passoutyear}}" placeholder="eg : 2015">
                   </div>
                </div>
                </div>
                <div class="inputacademicfield">
                    <div class="headertext">
                     ...
                     <div class="inputfield">
                        <label>Level : </label>
                        <input class="field" type="text" name="bachelorlevel"  value="{{$students->bachelor}}" placeholder="eg : bachelor in software engineering">
                       </div>
                   <div class="inputfield">
                    <label>CGPA/GRADE : </label>
                    <input class="field" type="text" name="bachelorgrade"  value="{{$students->bachelor_score}}" placeholder="eg : 3.4gpa">
                   </div>
                   <div class="inputfield">
                    <label>PassOutYear : </label>
                    <input class="field" type="date" name="bachelorpassoutyear"  value="{{$students->bachelor_passoutyear}}" placeholder="eg : 2021">
                   </div>
                </div>
                </div>
                <div class="inputacademicfield">
                    <div class="headertext">
                     ...
                     <div class="inputfield">
                        <label>Level : </label>
                        <input class="field" type="text" name="masterlevel"  value="{{$students->master}}" placeholder="eg: master in economics">
                       </div>
                   <div class="inputfield">
                    <label>CGPA/GRADE : </label>
                    <input class="field" type="text" name="mastergrade"  value="{{$students->master_score}}" placeholder="eg: 3.4cgpa">
                   </div>
                   <div class="inputfield">
                    <label>PassOutYear : </label>
                    <input class="field" type="date" name="masterpassoutyear"  value="{{$students->master_passoutyear}}" placeholder="eg: 2021">
                   </div>
                </div>
                </div>
            </div>
        ...
        <div class="course-detail">
            ...
            <div class="formpart">
                <div class="inputfield">
                    ...
                    <input class="field" type="text" name="interest_country"  value="{{$students->interest_country}}" placeholder="enter your interest country">
                </div>
                <div class="inputfield">
                    <label>Interest City : </label>
                    <input class="field" type="text" name="interest_city"  value="{{$students->interest_city}}" placeholder="enter yoir interest city">
                </div>
                <div class="inputfield">
                    <label>Interest Course : </label>
                    <input class="field" type="text" name="interest_course"  value="{{$students->interest_course}}" placeholder="enter your interest course">
                </div>
            </div>
        </div>
            ...
            <div class="formpart">
                <div class="inputacademicfield">
                   ...
                   <div class="inputfield">
                    ...
                    <input class="field" type="text" name="ieltsoverall"  value="{{$students->ielts}}" placeholder="enter ielts overall score">
                   </div>
                   <div class="inputfield">
                ...
                <div class="inputacademicfield">
                   ...
                   <div class="inputfield">
                    <label>Overall score : </label>
                    <input class="field" type="text" name="ieltsukvioverall"  value="{{$students->ielts_ukvi}}" placeholder="enter ieltsukvi overall score">
                   </div>
                   <div class="inputfield">
                    <label>Not less then score : </label>
                ...
                <div class="inputacademicfield">
                   ...
                   <div class="inputfield">
                    <label>Overall score : </label>
                    <input class="field" type="text" name="pteoverall"  value="{{$students->pte}}" placeholder="enter pte overall score">
                   </div>
                   <div class="inputfield">
                    <label>Not less then score : </label>
                ...
                <div class="inputacademicfield">
                   ...
                   <div class="inputfield">
                    <label>Overall score : </label>
                    <input class="field" type="text" name="toefloverall"  value="{{$students->tofel}}" placeholder="enter toefl overall">
                   </div>
                   <div class="inputfield">
                    <label>Not less then score : </label>
                ...
                <div class="inputacademicfield">
                   ...
                   <div class="inputfield">
                    <label>Overall score : </label>
                    <input class="field" type="text" name="satoverall"  value="{{$students->sat}}" placeholder="enter satoverall score">
                   </div>
                   <div class="inputfield">
                    <label>Not less then score : </label>
                ...
                <div class="inputacademicfield">
                   ...
                   <div class="inputfield">
                    <label>Overall score : </label>
                    <input class="field" type="text" name="greoverall"  value="{{$students->gre}}" placeholder="enter greoverall score">
                   </div>
                   <div class="inputfield">
                    <label>Not less then score : </label>
        ...
        <div class="extra-detail">
            <div class="formpart">
                <div class="inputfield">
                    ...
                    <input class="field" type="text" name="test_preparation"  value="{{$students->test_preparation}}" placeholder="eg : ielts">
                </div>
                <div class="inputfield">
                    <label>Work Experience : </label>
                    <input class="field" type="text" name="work_experience"  value="{{$students->work_experience}}" placeholder="enter your work experience">
                </div>
                <div class="inputfield">
                    <label>Visa Rejection : </label>
                    <input class="field" type="text" name="visa_rejection" value="{{$students->visa_rejection}}" placeholder="eg: not rejected till now">
                </div>
                <div class="inputfield">
                ...
                <div class="inputfield">
                    ...
                    <input class="field" type="text" name="counseled_by" value="{{$students->counseled_by}}" placeholder="eg : ragab sir">
                </div>
                <div class="inputfield">
                    <label>Rmarks : </label>
                    <input class="field" type="text" name="remark" value="{{$students->remark}}" placeholder="enter remark">
                </div>
            </div>
        </div>
        <div class="submitbtn">
