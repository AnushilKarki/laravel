    ...
    <button class="field" type="submit">Submit</button>
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    <input class="field" type="text" name="name" value="{{$students->name}}">
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <input class="field" type="text" name="email" value="{{$students->email}}">
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <input class="field" type="text" name="address" value="{{$students->address}}">
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                ...
                <td>
                    <input class="field" type="text" name="highest_acheived" value="{{$students->highest_acheived}}">
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <input class="field" type="text" name="cgpa" value="{{$students->cgpa}}">
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <input class="field" type="text" name="test_preparation" value="{{$students->test_preparation}}">
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <input class="field" type="text" name="test_score" value="{{$students->test_score}}">
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <input class="field" type="text" name="interest_country" value="{{$students->interest_country}}">
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <input class="field" type="text" name="interest_course" value="{{$students->interest_course}}">
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <input class="field" type="text" name="work_experience" value="{{$students->work_experience}}">
                </td>
            </tr>
            <tr>
                <td>
